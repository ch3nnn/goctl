...
import (
	...
	"gitlab.bolean.com/sa-micro-team/goctl/api"
	"gitlab.bolean.com/sa-micro-team/goctl/bug"
	"gitlab.bolean.com/sa-micro-team/goctl/docker"
	"gitlab.bolean.com/sa-micro-team/goctl/env"
	"gitlab.bolean.com/sa-micro-team/goctl/gateway"
	"gitlab.bolean.com/sa-micro-team/goctl/internal/cobrax"
	"gitlab.bolean.com/sa-micro-team/goctl/internal/version"
	"gitlab.bolean.com/sa-micro-team/goctl/kube"
	"gitlab.bolean.com/sa-micro-team/goctl/migrate"
	"gitlab.bolean.com/sa-micro-team/goctl/model"
	"gitlab.bolean.com/sa-micro-team/goctl/quickstart"
	"gitlab.bolean.com/sa-micro-team/goctl/rpc"
	"gitlab.bolean.com/sa-micro-team/goctl/tpl"
	"gitlab.bolean.com/sa-micro-team/goctl/upgrade"
)
